...
%8th page
\setnewpagemargins
%\marginnote{\center\hspace*{-0.6cm}\includegraphics[width=\marginparwidth-25pt]{images/matrix.png}\vspace*{-0.6cm}\\\center\hspace*{-0.7cm}\footnotesize{}}[0pt]

\hspace*{-2.5cm}\marginnote{
      \vspace*{0.7cm}
    \begin{equation*}
      A = 
      \begin{pmatrix}
...
\marginnote{%
    \hspace*{20pt}\small{For example, for $m = 7$ all we know is} \\
    \vspace{-0.2cm} % Adjust the vertical space here
    \begin{equation*}
        \sqrt[5]{344} \leq \Theta(C_7) \leq \frac{7}{1+(\cos{\frac{\pi}{7}}^{-1})},
    \end{equation*}
    \hspace*{20pt}which is \ \ $3.2141 \leq \Theta(C_7) \leq 3.3177$.
} 
